...
const Loader = () => {
  return (
    <>
      <Skeleton className="w-full h-72 lg:h-80 bg-default-900 rounde-xl" />
      <List direction="vertical" className="col-span-2">
        <Skeleton className="w-3/4 h-8 bg-default-900" />
        <Skeleton className="w-2/5 h-8 bg-default-900" />
        <Skeleton className="mt-2 w-full h-16 bg-default-900" />
      </List>
    </>
  );
};
