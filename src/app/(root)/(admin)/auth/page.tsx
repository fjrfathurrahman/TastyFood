import { BoxGrid } from "@/components/common";
import { MainContainer } from "@/components/containers/MainContainer";
import { FormAuth } from "@/components/layouts/Form";

export default function AuthPage(): JSX.Element {
  return (
    <MainContainer>
      <BoxGrid className="grid-cols-2">
        <ImageGrid />
        <FormAuth />
      </BoxGrid>
    </MainContainer>
...
const ImageGrid = (): JSX.Element => {
  return (
    <div className="grid grid-cols-3 grid-rows-3 gap-2.5 *:rounded-3xl">
