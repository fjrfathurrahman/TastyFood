            ...
            <List>
              ...
              <div className="flex items-center gap-4">
                <Link
                  ...
                  className="text-3xl xl:text-4xl text-blue-400"
                >
                  <Icons.MdFacebook />
                </Link>
                <Link
                  href={`https://www.youtube.com/channel/${data?.company_name}`}
                  className="text-3xl xl:text-4xl text-red-500"
                >
                  <Icons.FaYoutube />
                </Link>
                <Link
                  href={`https://twitter.com/${data?.twitter}`}
                  className="text-3xl xl:text-4xl text-white"
                >
